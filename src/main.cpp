...
#define DEEP_SLEEP_DURATION_US 5000000 // Deep sleep duration in microseconds (5 seconds = 5,000,000 microseconds)
...
void setup()
{
  ...
  shutdownDisplay(); // Shutdown display properly before deep sleep
